...
export default function DiscussionPost({
  ...
  const sentAt = `${timeSent.toLocaleDateString(
    undefined,
    dateOptions
  )} at ${timeSent.toLocaleTimeString(undefined, timeOptions)}`;
  ...
  async function deleteThisMessage() {
    firebase
      ...
      .delete()
      .then(() => {
        const newMessages = discussion.messages.filter(
  ...
  return (
    <GreyDiv>
      ...
      <StyledModal show={showDelete} centered>
        ...
        <Modal.Footer>
          <StyledButton onClick={() => setShowDelete(false)}>
            Cancel
          </StyledButton>
